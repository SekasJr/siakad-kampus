    ...
    <div class="col-sm-6">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Ruangan</label>
                    <input name="ruangan" value="<?= $ruangan['ruangan'] ?>" class="form-control" placeholder="Nama ruangan" required>
                </div>
                

            </div>
            <div class="modal-footer">
                <a href="<?= base_url('ruangan')?>" class="btn btn-warning pull-left btn-flat">Kembali</a>
